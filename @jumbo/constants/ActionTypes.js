...
//Home
export const GET_PICTURE_DATA = 'get_picture_data'
...
//News
export const GET_POST_CARD_DATA = 'get_post_card_data'
export const GET_VIDEO_POST_DATA = 'get_video_post_data'
...
export const GET_IMAGE_PRODUCT_INFO = 'get_image_info'
