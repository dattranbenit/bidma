    ...
    <SvgIcon width="18" height="18" viewBox="0 0 20 20" fill="none" {...props}>
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path
          ...
          stroke-linejoin="round"
        />
        <path d="M6.6665 1.66675V5.00008" stroke="#E26740" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M2.5 8.33325H17.5" stroke="#E26740" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      </svg>
    </SvgIcon>
  );
}
